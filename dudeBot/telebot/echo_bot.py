...
privetstvie = ["Привет!", "Приветствую!", "Йоу!", "Здарова!", "Однако здравствуй, сударь!", "Здравствуй, коль не шутишь!"]
how_are_you = ["Отлично!", "Хорошо!", "Да норм!"]
good_bye = ["Пока", "Удачи", "Попутного ветра Тоби!"]
what_is_your_name = ["хАй молодой, i'm Dude Bot, u know, yup?"]

token ="875263851:AAEWA5QePV6YUvCF9K4MC9egnpgkNocDC2o"
...
def main(message):
    ...
    elif message.text == "Как тебя зовут?" or message.text == "как тебя зовут?" or message.text == "Как тебя зовут" or message.text == "как тебя зовут" or message.text == "what's ur name?"
